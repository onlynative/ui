...
<SnackExample
  name="OnlyNative List — Usage"
  code={`import { List, ListItem, ListDivider } from '@onlynative/components'
...
<SnackExample
  name="OnlyNative List — Leading & Trailing"
  code={`import { List, ListItem } from '@onlynative/components'
import { ThemeProvider } from '@onlynative/core'
import { SafeAreaProvider } from 'react-native-safe-area-context'
...
<SnackExample
  name="OnlyNative List — Interactive"
  code={`import { List, ListItem } from '@onlynative/components'
import { ThemeProvider } from '@onlynative/core'
import { SafeAreaProvider } from 'react-native-safe-area-context'
...
<SnackExample
  name="OnlyNative List — Inset Dividers"
  code={`import { List, ListItem, ListDivider } from '@onlynative/components'
import { ThemeProvider } from '@onlynative/core'
import { SafeAreaProvider } from 'react-native-safe-area-context'
import { MaterialCommunityIcons } from '@expo/vector-icons'
