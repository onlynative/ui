...
<SnackExample
  name="OnlyNative Box — Usage"
  code={`import { Box, Typography } from '@onlynative/components'
...
<SnackExample
  name="OnlyNative Box — Raw spacing"
  code={`import { Box, Typography } from '@onlynative/components'
import { ThemeProvider } from '@onlynative/core'
import { SafeAreaProvider } from 'react-native-safe-area-context'
import { View } from 'react-native'
...
<SnackExample
  name="OnlyNative Box — Padding & Margin"
  code={`import { Box, Typography } from '@onlynative/components'
import { ThemeProvider } from '@onlynative/core'
import { SafeAreaProvider } from 'react-native-safe-area-context'
import { View } from 'react-native'
...
<SnackExample
  name="OnlyNative Box — Gap"
  code={`import { Box, Button } from '@onlynative/components'
import { ThemeProvider } from '@onlynative/core'
import { SafeAreaProvider } from 'react-native-safe-area-context'
import { View } from 'react-native'
