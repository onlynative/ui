...
<SnackExample
  name="OnlyNative Portal — Setup"
  code={`import { PortalHost, Typography } from '@onlynative/components'
...
<SnackExample
  name="OnlyNative Portal — Usage"
  code={`import { Button, Portal, PortalHost, Typography } from '@onlynative/components'
import { ThemeProvider } from '@onlynative/core'
import { SafeAreaProvider } from 'react-native-safe-area-context'
