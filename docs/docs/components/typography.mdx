...
<SnackExample
  name="OnlyNative Typography — Usage"
  code={`import { Typography } from '@onlynative/components'
...
<SnackExample
  name="OnlyNative Typography — Custom Styles"
  code={`import { Typography } from '@onlynative/components'
import { ThemeProvider } from '@onlynative/core'
import { SafeAreaProvider } from 'react-native-safe-area-context'
import { View } from 'react-native'
...
<SnackExample
  name="OnlyNative Typography — Custom Component"
  code={`import { Typography } from '@onlynative/components'
import { ThemeProvider } from '@onlynative/core'
import { SafeAreaProvider } from 'react-native-safe-area-context'
