...
<SnackExample
  name="OnlyNative KeyboardAvoidingWrapper — Usage"
  platform="ios"
  code={`import { KeyboardAvoidingWrapper, TextField } from '@onlynative/components'
...
<SnackExample
  name="OnlyNative KeyboardAvoidingWrapper — Events"
  platform="ios"
  code={`import { KeyboardAvoidingWrapper, TextField, Typography } from '@onlynative/components'
import { ThemeProvider } from '@onlynative/core'
import { SafeAreaProvider } from 'react-native-safe-area-context'
import { useState } from 'react'
