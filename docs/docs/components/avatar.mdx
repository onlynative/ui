...
<SnackExample
  name="OnlyNative Avatar — Usage"
  code={`import { Avatar } from '@onlynative/components'
...
<SnackExample
  name="OnlyNative Avatar — Interactive"
  code={`import { Avatar } from '@onlynative/components'
import { ThemeProvider } from '@onlynative/core'
import { SafeAreaProvider } from 'react-native-safe-area-context'
...
<SnackExample
  name="OnlyNative Avatar — Custom Colors"
  code={`import { Avatar } from '@onlynative/components'
import { ThemeProvider } from '@onlynative/core'
import { SafeAreaProvider } from 'react-native-safe-area-context'
import { View } from 'react-native'
