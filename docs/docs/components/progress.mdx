...
<SnackExample
  name="OnlyNative LinearProgress — Usage"
  code={`
...
<SnackExample
  name="OnlyNative CircularProgress — Usage"
  code={`
...
<SnackExample
  name="OnlyNative Progress — Indeterminate"
  code={`
...
<SnackExample
  name="OnlyNative Progress — Sizing"
  code={`
  import { CircularProgress, LinearProgress } from '@onlynative/components'
  import { ThemeProvider } from '@onlynative/core'
  import { SafeAreaProvider } from 'react-native-safe-area-context'
...
<SnackExample
  name="OnlyNative Progress — Custom colors"
  code={`
  import { CircularProgress, LinearProgress } from '@onlynative/components'
  import { ThemeProvider } from '@onlynative/core'
  import { SafeAreaProvider } from 'react-native-safe-area-context'
